            ...
            foreach ( $this->view_totals as $type => $count ) {
                ...
                switch ( $type ) {
                    case 'all':
                        ...
                        break;
                    case 'install':
                        $text = _nx( 'To Install <span class="count">(%s)</span>', 'To Install <span class="count">(%s)</span>', $count, 'plugins', 'tgmpa' );
                        break;
                    case 'update':
                        $text = _nx( 'Update Available <span class="count">(%s)</span>', 'Update Available <span class="count">(%s)</span>', $count, 'plugins', 'tgmpa' );
                        break;
                    case 'activate':
                        $text = _nx( 'To Activate <span class="count">(%s)</span>', 'To Activate <span class="count">(%s)</span>', $count, 'plugins', 'tgmpa' );
                        break;
                    default:
                        $text = '';
                        break;
            ...
            if ( 'tgmpa-bulk-activate' === $this->current_action() ) {
                ...
                if ( is_wp_error( $activate ) ) {
                    ...
                    printf( // WPCS: xss ok.
                        ...
                        esc_html( _nx( 'The following plugin was activated successfully:', 'The following plugins were activated successfully:', $count, 'plugin', 'tgmpa' ) ),
                        $imploded
                    );
