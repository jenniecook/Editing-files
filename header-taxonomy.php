...
<?php get_template_part( 'partials/head' ); ?>
    ...
    <body id="body" <?php body_class(); ?>>
      ...
      if (isset(get_queried_object()->taxonomy)) {
        ...
        ?>
        <div class="top-wrapper <?php echo (get_queried_object()->taxonomy == 'musicflow-events-places')? 'big-wrapper' : 'small-wrapper'; ?> skin-background-color2 header-background-<?php echo get_queried_object_id(); ?>">
        <?php
      } else {
      ...
      ?>
        <div class="top-wrapper-mask">
          <div class="center-wrapper">
            ...
            <?php if (get_query_var( 'taxonomy' ) == 'musicflow-events-places'): ?>
              ...
              <?php if (have_posts()): ?>
                ...
                <div class="top-content">
                  <div class="three-fourth main-content-responsive">
                    <h1 class="skin-font-color3"><?php _e( 'Place', "musicflow_theme" ); ?>:
