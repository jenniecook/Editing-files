        ...
        <?php if ( ! have_posts() ) : ?>
          ...
          <div class="three-fourth main-content-responsive">
            ...
            <div class="main-content">
              ...
              <h2 class="skin-font-color5"><?php _e( 'No found', "musicflow_theme" ); ?> <span class="bold"><?php _e( 'Galleries', "musicflow_theme" ); ?></span></h2>
            </div>
        ...
        <?php else: ?>
          ...
          <div class="three-fourth main-content-responsive">
            ...
            <div class="main-content">
              ...
              <h2 class="skin-font-color5"><?php _e( 'All galleries by', "musicflow_theme" ); ?>
