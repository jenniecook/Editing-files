        ...
        <?php if ( ! have_posts() ) : ?>
          ...
          <div class="three-fourth main-content-responsive">
            ...
            <div class="main-content">
              ...
              <h2 class="skin-font-color5"><?php _e( 'No found', "musicflow_theme" ); ?> <span class="bold"><?php _e( 'news', "musicflow_theme" ); ?></span></h2>
            </div>
        ...
        <?php else: ?>
          ...
          <div class="three-fourth main-content-responsive">
            ...
            <div class="main-content">
              ...
              <h2 class="skin-font-color5"><?php _e( 'All news by', "musicflow_theme" ); ?>
                <span class="bold"><?php esc_html(single_cat_title( '' )); ?></span>
              </h2>
              <?php
